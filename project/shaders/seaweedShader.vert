...
void main() {
    vec3 offset = vec3(cos(aVertexPosition.y)*cos(timeFactor),0,sin(aVertexPosition.y)*sin(timeFactor))*aVertexPosition.y*0.1;
    // Transformed Vertex position
    vec4 vertex = uMVMatrix * vec4(aVertexPosition + offset*0.2, 1.0);
