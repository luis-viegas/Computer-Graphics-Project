...
export class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        this.texMineTop = new CGFtexture(this, "images/mineTop.png");
        this.texMineSide = new CGFtexture(this, "images/mineSide.png");
        this.texMineBottom = new CGFtexture(this, "images/mineBottom.png");
        this.cube = new MyUnitCubeQuad(this,this.texMineTop, this.texMineSide, this.texMineSide,
            this.texMineSide, this.texMineSide, this.texMineBottom);
